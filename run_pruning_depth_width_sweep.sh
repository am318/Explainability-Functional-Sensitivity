...
SWEEP_SCRIPT="Pruning_Experimental_Sweep.py"

# Keep output/check artifacts and logs isolated from the other sweep.
OUTPUT_BASE="Plots/Pruning"
LOG_DIR="logs/pruning_depth_width"
...
launch_job() {
  ...
  case "$dataset" in
    ...
    symmetric_vector_field)   dataset_dir="${OUTPUT_BASE}/exp_test" ;;
    vanderpol_vector_field)   dataset_dir="${OUTPUT_BASE}/vanderpol" ;;
